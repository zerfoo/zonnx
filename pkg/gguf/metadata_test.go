...
func TestMapMetadata_AllFields(t *testing.T) {
	...
	expected := map[string]MetadataEntry{
		...
		"llama.embedding_length":                        {Type: TypeUint32, Value: uint32(4096)},
		"llama.block_count":                             {Type: TypeUint32, Value: uint32(32)},
		"llama.attention.head_count":                    {Type: TypeUint32, Value: uint32(32)},
		"llama.attention.head_count_kv":                 {Type: TypeUint32, Value: uint32(8)},
		"llama.feed_forward_length":                     {Type: TypeUint32, Value: uint32(11008)},
		"llama.vocab_size":                              {Type: TypeUint32, Value: uint32(32000)},
		"llama.context_length":                          {Type: TypeUint32, Value: uint32(2048)},
		"llama.attention.layer_norm_rms_epsilon":        {Type: TypeFloat32, Value: float32(1e-5)},
		"llama.rope.freq_base":                          {Type: TypeFloat32, Value: float32(10000.0)},
	}
